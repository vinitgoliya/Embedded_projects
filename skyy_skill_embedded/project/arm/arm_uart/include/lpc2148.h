...
//#define AD0DR1          (*((volatile unsigned long *) 0xE0034004))
//#define AD0DR1  (*((volatile unsigned long *)0xE0034008)) // ADC Channel 1 Data Register
#define AD0DR0  (*((volatile unsigned long *)0xE0034004))
#define AD0DR1  (*((volatile unsigned long *)0xE0034008))
#define AD0DR2  (*((volatile unsigned long *)0xE003400C))
#define AD0DR3  (*((volatile unsigned long *)0xE0034010))
#define AD0DR4  (*((volatile unsigned long *)0xE0034014))
#define AD0DR5  (*((volatile unsigned long *)0xE0034018))
#define AD0DR6  (*((volatile unsigned long *)0xE003401C))
#define AD0DR7  (*((volatile unsigned long *)0xE0034020))
